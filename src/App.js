...
function App() {
  ...
  const listpj = [
    { name: "Dunet - Cổng donate cho streamer", tech: "Laravel, Mysql ...", image: "https://mir-s3-cdn-cf.behance.net/projects/max_808_webp/09b1f2159641421.Y3JvcCw4MDgsNjMyLDAsMA.png", cpn: <Dunet />, sp: 0 },
    { name: "Binance login with QR", tech: "React Native, Laravel,...", image: "https://mir-s3-cdn-cf.behance.net/projects/max_808_webp/3fbdba159387565.Y3JvcCwxMzgwLDEwODAsMjcwLDA.png", cpn: <BinanceLG />, sp: 2 },
    ...
    { name: "Website đặt vé du lịch", tech: "Reactjs, Cloudinary, Laravel,...", image: "https://mir-s3-cdn-cf.behance.net/projects/max_808_webp/753ee0139128899.Y3JvcCwxMzgwLDEwODAsMjcwLDA.png", cpn: <Wdatvedulich />, sp: 0 },
    { name: "Ứng dụng đặt tour du lịch", tech: "React native, Larave, Mysql,...", image: "https://mir-s3-cdn-cf.behance.net/projects/max_808_webp/98da89136545111.Y3JvcCw4MjcsNjQ3LDY1LDA.png", cpn: <Udattourdulich />, sp: 1 },
    { name: "Ứng dụng quản lý tiền", tech: "React Native, Expo, SqLite,....", image: "https://mir-s3-cdn-cf.behance.net/projects/404_webp/4323cc136544603.Y3JvcCw2NDUsNTA1LDM4LDMz.png", cpn: <Quanlytien />, sp: 1 },
    ...
    { name: "Website xem tivi trực tuyến NTIVI", tech: "WordPress,..", image: "https://mir-s3-cdn-cf.behance.net/projects/max_808_webp/8daebd136543067.Y3JvcCwxMjUxLDk3OSwzMzQsMA.png", cpn: <Ntivi />, sp: 0 },
    { name: "Website tuổi thơ việt SAIGON'S GAME", tech: "PHP, MySQL, Laravel,...", image: "https://mir-s3-cdn-cf.behance.net/projects/max_808_webp/2cd5b6136542883.Y3JvcCwxMjU2LDk4Myw0MDcsMA.jpg", cpn: <Tuoithoviet />, sp: 0 },
    { name: "Website sell game accounts", tech: "PHP, MySQL, JQUERY, AJAX...", image: "https://mir-s3-cdn-cf.behance.net/projects/max_808_webp/9b106c136542661.Y3JvcCwxMzgwLDEwODAsNiww.png", cpn: <Ngame />, sp: 0 },
    { name: "Hệ thống quản lý trường học 8888", tech: " PHP, MySQL, Cloudinary, Firebase,...", image: "https://mir-s3-cdn-cf.behance.net/projects/max_808_webp/340590136542111.Y3JvcCwxMTM3LDg4OSwwLDA.png", cpn: <QL8888 />, sp: 2 },
