...
export default function Udattourdulich() {
    return (
        <div className='main' style={{ backgroundColor: '#414A58' }}>
            ...
            <img src='https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/2b049c136545111.61fb6d82e1e69.png' />
            <div className='slideimg'>
                <img style={{ width: `${100 / 3}%` }} src='https://mir-s3-cdn-cf.behance.net/project_modules/1400/3c1229136545111.61fb6d8222c4a.jpg' />

                <img style={{ width: `${100 / 3}%` }} src='https://mir-s3-cdn-cf.behance.net/project_modules/1400/88be77136545111.61fb6d8223410.jpg' />

                <img style={{ width: `${100 / 3}%` }} src='https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/1f0567136545111.61fb6d8223ae7.jpg' />
